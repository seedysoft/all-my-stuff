...
namespace Seedysoft.Carburantes.Infrastructure.Migrations.Carburantes
{
    ...
    [Migration("20230819083536_InitialCarburantesDbContext")]
    partial class InitialCarburantesDbContext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Carburantes.CoreLib.Entities.ComunidadAutonoma", b =>
                {
            ...
            modelBuilder.Entity("Carburantes.CoreLib.Entities.ComunidadAutonomaHist", b =>
                {
                    b.Property<int>("IdComunidadAutonoma")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Carburantes.CoreLib.Entities.EstacionProductoPrecio", b =>
                {
            ...
            modelBuilder.Entity("Carburantes.CoreLib.Entities.EstacionProductoPrecioHist", b =>
                {
                    b.Property<int>("IdEstacion")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Carburantes.CoreLib.Entities.EstacionServicio", b =>
                {
                    b.Property<int>("IdEstacion")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Carburantes.CoreLib.Entities.EstacionServicioHist", b =>
                {
                    b.Property<int>("IdEstacion")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Carburantes.CoreLib.Entities.Municipio", b =>
                {
                    b.Property<int>("IdMunicipio")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Carburantes.CoreLib.Entities.MunicipioHist", b =>
                {
                    b.Property<int>("IdMunicipio")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Carburantes.CoreLib.Entities.ProductoPetrolifero", b =>
                {
                    b.Property<int>("IdProducto")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Carburantes.CoreLib.Entities.ProductoPetroliferoHist", b =>
                {
                    b.Property<int>("IdProducto")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Carburantes.CoreLib.Entities.Provincia", b =>
                {
                    b.Property<int>("IdProvincia")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Carburantes.CoreLib.Entities.ProvinciaHist", b =>
                {
                    b.Property<int>("IdProvincia")
                        .HasColumnType("INTEGER");
