...
{
    protected internal readonly JsObjectRef _jsObjectRef;
    ...
    {
        JsObjectRef jsObjectRef = await JsObjectRef.CreateAsync(jsRuntime, "google.maps.LatLngBounds");
    ...
    protected LatLngBounds(JsObjectRef jsObjectRef) => _jsObjectRef = jsObjectRef;
