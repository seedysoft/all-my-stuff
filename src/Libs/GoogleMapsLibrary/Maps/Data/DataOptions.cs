...
/// <summary>
/// <see cref="DataOptions"> object used to define the properties that a developer can set on a <see cref="MapData"> object.
/// </summary>
/// <see href="https://developers.google.com/maps/documentation/javascript/reference/data#Data.DataOptions"/>
public class DataOptions
{
    ...
    ///// <summary>
    ///// <see cref="Map"/> on which to display the features in the collection.
    ///// </summary>
