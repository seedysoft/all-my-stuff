...
//public class ImageMapType : MVCObject, IDisposable
//{
...
//    {
//        string realUrl = baseUrlFormat.Replace("{z}", "' + zoom + '").Replace("{x}", "' + coord.x + '").Replace("{y}", "' + coord.y + '");
//        string initOpts = @"{
...
//        JsObjectRef jsObjectRef = await JsObjectRef.CreateAsync(jsRuntime, "google.maps.ImageMapType", initOpts);
...
//    /// <param name="opacity"></param>
//    /// <returns></returns>
//    public async Task SetOpacity(decimal opacity) => await SetOpacity(Convert.ToDouble(opacity));
//}
