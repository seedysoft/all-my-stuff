...
/// </summary>
/// <see href=""/>
public class AdvancedMarkerElementOptions 
{
    /// <summary>
    /// Sets the AdvancedMarkerElement's position.
    /// An AdvancedMarkerElement may be constructed without a position, but will not be displayed until its position is provided - for example, by a user's actions or choices.
    /// An AdvancedMarkerElement's position can be provided by setting AdvancedMarkerElement.position if not provided at the construction.
