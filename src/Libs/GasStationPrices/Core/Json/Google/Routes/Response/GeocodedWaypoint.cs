...
public class GeocodedWaypoint
{
    ...
    /// </summary>
    [J("geocoderStatus"), I(Condition = C.WhenWritingNull)] public Status? GeocoderStatus { get; set; }
    /// <summary>
    ...
    /// </summary>
    [J("type"), I(Condition = C.WhenWritingNull)] public string[]? Type { get; set; }
    /// <summary>
    ...
    /// </summary>
    [J("partialMatch")] public bool PartialMatch { get; set; }
    /// <summary>
    ...
    /// </summary>
    [J("intermediateWaypointRequestIndex"), I(Condition = C.WhenWritingNull)] public long? IntermediateWaypointRequestIndex { get; set; }
}
