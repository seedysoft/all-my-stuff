...
/// <summary>
/// Provides summarized information about different multi-modal segments of the <see cref="RouteLeg.Steps"/>. A multi-modal segment is defined as one or more contiguous <see cref="RouteLegStep"/> that have the same <see cref="RouteTravelMode"/>. This field is not populated if the <see cref="RouteLeg"/> does not contain any multi-modal segments in the steps.
/// </summary>
