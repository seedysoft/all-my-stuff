...
public class FallbackInfo
{
    ...
    /// </summary>
    [J("routingMode"), I(Condition = C.WhenWritingDefault), K(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))]
    public required FallbackRoutingMode RoutingMode { get; set; }
    /// <summary>
    ...
    /// </summary>
    [J("reason"), I(Condition = C.WhenWritingDefault), K(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))]
    public required FallbackReason Reason { get; set; }
}
