...
public class Body
{
    ...
    /// </summary>
    [J("travelMode")][I(Condition = C.WhenWritingNull)][K(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))] public Shared.RouteTravelMode? TravelMode { get; set; }
    ...
    /// </summary>
    [J("routingPreference")][I(Condition = C.WhenWritingNull)][K(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))] public Shared.RoutingPreference? RoutingPreference { get; set; }

    /// <summary>
    /// Optional. Specifies your preference for the quality of the polyline.
    /// </summary>
    [J("polylineQuality")][I(Condition = C.WhenWritingNull)][K(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))] public Shared.PolylineQuality? PolylineQuality { get; set; }

    /// <summary>
    /// Optional. Specifies the preferred encoding for the polyline.
    /// </summary>
    [J("polylineEncoding")][I(Condition = C.WhenWritingNull)][K(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))] public Shared.PolylineEncoding? PolylineEncoding { get; set; }
    ...
    /// </summary>
    [J("units")][I(Condition = C.WhenWritingNull)][K(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))] public Shared.Units? Units { get; set; }
    ...
    /// </summary>
    [J("requestedReferenceRoutes")][I(Condition = C.WhenWritingNull)][K(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))] public Shared.ReferenceRoute? RequestedReferenceRoutes { get; set; }
    ...
    /// </summary>
    [J("trafficModel")][I(Condition = C.WhenWritingNull)][K(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))] public Shared.TrafficModel? TrafficModel { get; set; }
