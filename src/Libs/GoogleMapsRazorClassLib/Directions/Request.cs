using OneOf;
using Seedysoft.Libs.GoogleMapsRazorClassLib.Serialization;
...
public class Request
{
    ...
    /// Required.
    /// </summary>
    [JsonConverter(typeof(OneOfJsonConverterFactory))]
    public required OneOf<string, LatLngLiteral, Place> Destination { get; set; }
    ...
    /// </summary>
    [JsonConverter(typeof(OneOfJsonConverterFactory))]
    public required OneOf<string, LatLngLiteral, Place> Origin { get; set; }
