...
public class Route
{
    ...
    /// </summary>
    [J("overview_path")] public IEnumerable<LatLngLiteral> OverviewPath { get; set; } = new List<LatLngLiteral>();
    ...
    /// </summary>
    [J("overview_polyline")] public string? OverviewPolyline { get; set; }
    ...
    /// </summary>
    [J("waypoint_order")] public List<int> WaypointOrder { get; set; } = [];
