...
/// based on the configured <see cref="Settings.RoutingSettings.CurrentImplName"/>.
...
public class RoutingService(IConfiguration configuration, ILogger<RoutingService> logger) : ServiceBase(configuration)
{
    ...
    /// Thrown when the configured routing implementation in <see cref="Settings.RoutingSettings.CurrentImpl"/>
