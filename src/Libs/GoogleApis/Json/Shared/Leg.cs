...
public class Leg
{
    ...
    [J("duration_in_traffic")] public Duration? DurationInTraffic { get; set; }

    /// <summary>
    /// The address of the destination of this leg.
    /// </summary>
    [J("end_address")] public string? EndAddress { get; set; }
    ...
    /// </summary>
    [J("end_location")] public LatLngLiteral? EndLocation { get; set; }

    /// <summary>
    /// The address of the origin of this leg.
    /// </summary>
    [J("start_address")] public string? StartAddress { get; set; }
    ...
    /// </summary>
    [J("start_location")] public LatLngLiteral? StartLocation { get; set; }
    ...
    /// </summary>
    [J("via_waypoints")] public IEnumerable<LatLngLiteral>? ViaWaypoints { get; set; }
}
