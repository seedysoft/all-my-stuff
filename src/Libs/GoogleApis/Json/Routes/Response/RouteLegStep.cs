...
public class RouteLegStep
{
    ...
    /// </summary>
    [J("startLocation"), I(Condition = C.WhenWritingNull)] public Seedysoft.Libs.GoogleApis.Json.Places.Request.Location? StartLocation { get; set; }
    /// <summary>
    /// The end location of this step.
    /// </summary>
    [J("endLocation"), I(Condition = C.WhenWritingNull)] public Seedysoft.Libs.GoogleApis.Json.Places.Request.Location? EndLocation { get; set; }
    /// <summary>
    /// The end location of this step.
    /// </summary>
    ...
    /// </summary>
    [J("travelAdvisory"), I(Condition = C.WhenWritingNull)] public RouteLegStepTravelAdvisory? TravelAdvisory { get; set; }
    /// <summary>
    /// Text representations of properties of the RouteLegStep.
    /// </summary>
    [J("localizedValues"), I(Condition = C.WhenWritingNull)] public RouteLegStepLocalizedValues? LocalizedValues { get; set; }
    /// <summary>
    /// Details pertaining to this step if the travel mode is TRANSIT.
    /// </summary>
    [J("transitDetails"), I(Condition = C.WhenWritingNull)] public RouteLegStepTransitDetails? TransitDetails { get; set; }
    /// <summary>
