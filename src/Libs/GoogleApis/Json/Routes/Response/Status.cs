...
public class Status
{
    ...
    /// </summary>
    [J("code")/*, I(Condition = C.WhenWritingNull)*/] public int Code { get; set; }
    /// <summary>
    /// A developer-facing error message, which should be in English. Any user-facing error message should be localized and sent in the google.rpc.Status.details field, or localized by the client.
    /// </summary>
    [J("message"), I(Condition = C.WhenWritingNull)] public string? Message { get; set; }
    /// <summary>
    ...
    /// </summary>
    [J("details"), I(Condition = C.WhenWritingNull)] public Detail[]? Details { get; set; }
}
