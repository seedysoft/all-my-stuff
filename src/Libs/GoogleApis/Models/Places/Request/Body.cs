namespace Seedysoft.Libs.GoogleApis.Models.Places.Request;
...
public class Body
{
    ...
    /// </summary>
    [J("locationbias"), I(Condition = C.WhenWritingNull)]
    public Shared.Location? LocationBias { get; set; }

    /// <summary>
    /// Specifies an area to search.
    /// Results outside the specified area are not returned.
    /// </summary>
    [J("locationrestriction"), I(Condition = C.WhenWritingNull)]
    public Shared.Location? LocationRestriction { get; set; }
    ...
    /// </summary>
    [J("includedPrimaryTypes"), I(Condition = C.WhenWritingNull)]
    ...
    /// </summary>
    [J("includedRegionCodes"), I(Condition = C.WhenWritingNull)]
    ...
    /// </summary>
    [J("origin"), I(Condition = C.WhenWritingNull)]
    public Shared.LatitudeLongitude? Origin { get; set; }
    ...
    /// </summary>
    [J("sessionToken"), I(Condition = C.WhenWritingNull)]
