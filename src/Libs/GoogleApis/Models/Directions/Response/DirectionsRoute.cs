...
public class DirectionsRoute
{
    ...
    ///// </summary>
    //public Models.Shared.LatLngBoundsLiteral? Bounds { get; init; }
    ...
    /// </summary>
    public IEnumerable<DirectionsLeg> Legs { get; init; } = [];
    ...
    ///// </summary>
    //[J("overview_path")]
    //public IEnumerable<Models.Shared.LatLngLiteral> OverviewPath { get; init; } = new List<Models.Shared.LatLngLiteral>();
    ...
    ///// </summary>
    //[J("overview_polyline")]
    //public string? OverviewPolyline { get; init; }
