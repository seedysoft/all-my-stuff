...
public class Waypoint
{
    ...
    /// </summary>
    [J("via"), I(Condition = C.WhenWritingNull)]
    ...
    /// </summary>
    [J("location"), I(Condition = C.WhenWritingNull)]
    public Models.Shared.Location? Location { get; set; }
    ...
    /// </summary>
    [J("address"), I(Condition = C.WhenWritingNull)]
