...
public static class Crypto
{
        ...
        Org.BouncyCastle.Crypto.IBlockCipher symmetricBlockCipher)
    {
        ...
        {
            System.Security.Cryptography.CipherMode.CBC => new Org.BouncyCastle.Crypto.Modes.CbcBlockCipher(symmetricBlockCipher),
            System.Security.Cryptography.CipherMode.ECB => new Org.BouncyCastle.Crypto.Modes.EcbBlockCipher(symmetricBlockCipher),
            _ => throw new ArgumentOutOfRangeException(nameof(cipherMode), cipherMode, "Cipher mode {0} not supported"),
        };
    }
